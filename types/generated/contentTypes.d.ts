...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Portoflio Projects';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    abilities: Schema.Attribute.Component<'project.ability', true>;
    category: Schema.Attribute.Enumeration<['web', 'app', 'branding']> &
      Schema.Attribute.Required &
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'electric'>;
    image: Schema.Attribute.Media<'images'>;
    level_text: Schema.Attribute.String;
